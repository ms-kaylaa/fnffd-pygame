...
class HealthBar(BasicSprite):
    ...
    def make_bar(self):
        ...
        # healthbar
        rect(self.base_image, self.outline_color, pygame.Rect((59, 356), (282, 19)))
        rect(self.base_image, self.player_color, pygame.Rect((61, 358), (278, 15)))
        rect(self.base_image, self.baddie_color, ((61, 358), (self.skill*0.01*278, 15)))
        ...
        self.base_image.blit(baddie_icon, pygame.Rect((((61-23)+self.skill*0.01*278)-23, (360+6)-25), (baddie_icon.get_width(), baddie_icon.get_height())))
        player_icon = self.player_icons[bh]
        self.base_image.blit(player_icon, pygame.Rect((((61+20)+self.skill*0.01*278)-(20), (360+6)-(23)), (player_icon.get_width(), player_icon.get_height())))

    def update(self, dt):
        self.current_time += dt/FPS
        self.sinny = round(math.sin((self.current_time*FPS)/10))

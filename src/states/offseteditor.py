...
def init():
    global grp,backsprite,char,cross,curanim,anims,ghostchar,scoretext
    grp = Camera()
    ...
    scoretext = globals.default_font.render(f"""OFFSETTER 2000 (tm)
...
def run():
    global cam_x,cam_y,backsprite,char,curanim,anims,ghostchar,scoretext
    print("we workign")
